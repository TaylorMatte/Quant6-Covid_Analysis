...
sunquest_format2 = N1Results[,!(names(N1Results) %in% drop)]
...
write.csv(bmc, file=paste("/Users/English/Desktop/", filename, ".csv", sep=""), quote=FALSE, row.names = FALSE)

write.csv(sunquest_format, file=paste("/Users/English/Desktop/", filename, "_CREM", ".csv", sep=""), quote=FALSE, row.names = FALSE)
...
write.csv(sumstats, file=paste("/Users/English/Desktop/", filename, "_summary", ".csv", sep=""), quote=FALSE, row.names = FALSE)
